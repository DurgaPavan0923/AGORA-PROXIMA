...
"[project]/client/components/dashboard-redirect-guard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function DashboardGuard({ children, requiredRole }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardGuard.useEffect": ()=>{
            const verifyAccess = {
                "DashboardGuard.useEffect.verifyAccess": async ()=>{
                    try {
            ...
            }["DashboardGuard.useEffect.verifyAccess"];
            verifyAccess();
        }
    }["DashboardGuard.useEffect"], [
        router,
...
_s(DashboardGuard, "vQduR7x+OPXj6PSmJyFnf+hU7bg=", false, function() {
    return [
...
//# sourceMappingURL=client_bee83280._.js.map